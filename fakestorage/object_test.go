...
func TestServerClientObjectProjection(t *testing.T) {
	...
	runServersTest(t, runServersOptions{objs: objs}, func(t *testing.T, server *Server) {
		...
		fullACL := []objectAccessControl{
			{Bucket: bucketName, Object: objectName, Entity: "user-1", Role: "OWNER", Etag: "CAE=", Kind: "storage#objectAccessControl"},
			{Bucket: bucketName, Object: objectName, Entity: "user-2", Role: "READER", Etag: "CAE=", Kind: "storage#objectAccessControl"},
		}
